...
public class Default {
    ...
    public static double tokenEqual(String str1, String str2) {
        return org.sotorrent.stringsimilarity.set.Base.tokenSimilarity(str1, str2, Base::equal);
    }

    // tokens + normalization
    public static double tokenEqualNormalized(String str1, String str2) {
        return org.sotorrent.stringsimilarity.set.Base.tokenSimilarityNormalized(str1, str2, Base::equal);
    }
}