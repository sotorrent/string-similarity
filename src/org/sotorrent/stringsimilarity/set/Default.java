...
import static org.sotorrent.stringsimilarity.Tokenization.SHINGLE_SIZE;
...
public class Default {
    ...
    public static double tokenDice(String str1, String str2) {
        return Base.tokenSimilarity(str1, str2, Base::dice);
    }

    // tokens + normalization
    public static double tokenDiceNormalized(String str1, String str2) {
        return Base.tokenSimilarityNormalized(str1, str2, Base::dice);
    }

    // ngrams
    public static double nGramDice(String str1, String str2) {
        return Base.nGramSimilarity(str1, str2, NGRAM_SIZE, Base::dice);
    }

    // ngrams + normalization
    public static double nGramDiceNormalized(String str1, String str2) {
        return Base.nGramSimilarityNormalized(str1, str2, NGRAM_SIZE, Base::dice);
    }

    // ngrams + normalization + padding
    public static double nGramDiceNormalizedPadding(String str1, String str2) {
        return Base.nGramSimilarityNormalizedPadding(str1, str2, NGRAM_SIZE, Base::dice);
    }

    // shingles
    public static double nShingleDice(String str1, String str2) {
        return Base.nShingleSimilarity(str1, str2, SHINGLE_SIZE, Base::dice);
    }

    // shingles + normalization
    public static double nShingleDiceNormalized(String str1, String str2) {
        return Base.nShingleSimilarityNormalized(str1, str2, SHINGLE_SIZE, Base::dice);
    }
    ...
    public static double tokenOverlap(String str1, String str2) {
        return Base.tokenSimilarity(str1, str2, Base::overlap);
    }

    // tokens + normalization
    public static double tokenOverlapNormalized(String str1, String str2) {
        return Base.tokenSimilarityNormalized(str1, str2, Base::overlap);
    }

    // ngrams
    public static double nGramOverlap(String str1, String str2) {
        return Base.nGramSimilarity(str1, str2, NGRAM_SIZE, Base::overlap);
    }

    // ngrams + normalization
    public static double nGramOverlapNormalized(String str1, String str2) {
        return Base.nGramSimilarityNormalized(str1, str2, NGRAM_SIZE, Base::overlap);
    }

    // ngrams + normalization + padding
    public static double nGramOverlapNormalizedPadding(String str1, String str2) {
        return Base.nGramSimilarityNormalizedPadding(str1, str2, NGRAM_SIZE, Base::overlap);
    }

    // shingles
    public static double nShingleOverlap(String str1, String str2) {
        return Base.nShingleSimilarity(str1, str2, SHINGLE_SIZE, Base::overlap);
    }

    // shingles + normalization
    public static double nShingleOverlapNormalized(String str1, String str2) {
        return Base.nShingleSimilarityNormalized(str1, str2, SHINGLE_SIZE, Base::overlap);
    }
